...
class Tool
{
	...
	static function custom_trim(?string $value)
	{
		return trim($value ?? '');
	}
	...
	static function buttonLink($label, $url = '#', $target = '_self', $title = "")
	{

		return '<input type="button" href="' . $url . '" target="' . $target . '" title="' . $title . '" value="' . $label . '">';
	}
